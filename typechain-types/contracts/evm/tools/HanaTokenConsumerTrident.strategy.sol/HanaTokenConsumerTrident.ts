...
export interface HanaTokenConsumerTridentInterface extends utils.Interface {
  functions: {
...
export interface HanaTokenConsumerTrident extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HanaTokenConsumerTridentInterface;
