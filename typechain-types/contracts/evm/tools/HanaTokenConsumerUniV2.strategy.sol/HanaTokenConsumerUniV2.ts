...
export interface HanaTokenConsumerUniV2Interface extends utils.Interface {
  functions: {
...
export interface HanaTokenConsumerUniV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HanaTokenConsumerUniV2Interface;
