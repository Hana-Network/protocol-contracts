...
export interface HanaConnectorEthInterface extends utils.Interface {
  functions: {
...
export interface HanaConnectorEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HanaConnectorEthInterface;
