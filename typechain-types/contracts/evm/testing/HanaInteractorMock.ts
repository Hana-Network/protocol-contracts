...
export interface HanaInteractorMockInterface extends utils.Interface {
  functions: {
...
export interface HanaInteractorMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HanaInteractorMockInterface;
