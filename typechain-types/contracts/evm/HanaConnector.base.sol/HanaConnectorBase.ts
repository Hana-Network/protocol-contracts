...
export interface HanaConnectorBaseInterface extends utils.Interface {
  functions: {
...
export interface HanaConnectorBase extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: HanaConnectorBaseInterface;
